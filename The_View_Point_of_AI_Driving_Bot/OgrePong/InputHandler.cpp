...
void InputHandler::createGameViewports()
{
    ...
    //Ogre::Viewport* rearvp = mRenderWindow->addViewport(mCameraR, 2, 0.25f, 0.85f, 0.5, 0.15);
    Ogre::Viewport* vp = mRenderWindow->addViewport(mCamera,1);
	Ogre::Viewport* vp_ai1= mRenderWindow->addViewport(mCamera_ai1,3, 0.0f, 0.0f, 1, 1);
