...
void 
	DebugInterface::SetDebugConsoleActive(bool activate)
{
...
void DebugInterface::addDebugText(std::string message)
{
	mDebugOutput.push_back(message);
	mDebugTimeRemaining.push_back(mMessageTime);
	resetOverlayText();
}
void DebugInterface::Think(float time)
{
	bool changed = false;
...
void 
	DebugInterface::clearDebugOutput()
{
...
void DebugInterface::resetOverlayText()
{
