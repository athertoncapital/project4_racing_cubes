...
void World::createWorldState() {
	...
	Mode = 0;//0 is prediction; 1 is training, and this value is only could be changed by designer manually 
...
void World::Think(const Ogre::Real& mTime)
{
    ...
    mTank->getMovingObject("AItank1")->translate(Normal(u2, AI_0_v)*10);
